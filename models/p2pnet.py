...
class P2PNet(nn.Module):
    ...
    def forward(self, samples: NestedTensor):
        ...
        features_fpn_P4 = self.fpn(features)

        regression = self.regression(features_fpn_P4) * 100 # 8x
        classification = self.classification(features_fpn_P4)
