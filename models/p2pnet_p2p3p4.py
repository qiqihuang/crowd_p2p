...
class P2PNet(nn.Module):
    def __init__(self, backbone, row=2, line=2, name='vgg'):
        ...
        self.classification_P3 = ClassificationModel(num_features_in=256, \
                                            ...
                                            num_anchor_points=num_anchor_points)
        self.concat = Concat()
        self.anchor_points = AnchorPoints(pyramid_levels=[2, 3, 4], row=row, line=line)
    ...
    def forward(self, samples: NestedTensor):
        ...
        output_coord = self.concat([reg_P3, reg_P4, reg_P5]) + anchor_points
        output_class = self.concat([cls_P3, cls_P4, cls_P5])
